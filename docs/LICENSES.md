...
This directory contains project-authored software, configuration, documentation, and UI/media assets for the Cockpit. For the complete project licensing information, see the root [`LICENSES.md`](../LICENSES.md).
