...
if exist "%PROJECT_ROOT%\requirements.txt" "%PYTHON%" -m pip install --no-warn-script-location -r "%PROJECT_ROOT%\requirements.txt" || exit /b %errorlevel%
echo Datalogger dependencies installed.
