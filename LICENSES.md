...
||---|---|---|
|| All project-authored code (cockpit/, control/, datalogger/, frontend/, configs/, scripts/, tests/) | PolyForm Noncommercial 1.0.0 | [`LICENSE-POLYFORM-NonCommercial-1.0.0.txt`](LICENSE-POLYFORM-NonCommercial-1.0.0.txt) |
...
|| Project material | Licence | Licence text |
||---|---|---|
|| `cockpit/src/rov_cockpit/`, `control/src/rov_control/`, `datalogger/src/rov_datalogger/`, `configs/`, `scripts/`, and project-authored code | PolyForm Noncommercial 1.0.0 | [`LICENSE-POLYFORM-NonCommercial-1.0.0.txt`](LICENSE-POLYFORM-NonCommercial-1.0.0.txt) |
|| Project-authored documentation, operating instructions, diagrams, and other copyrightable written or visual material | CC BY-NC-SA 4.0 | [`LICENSE-CC-BY-NC-SA-4.0.txt`](LICENSE-CC-BY-NC-SA-4.0.txt) |
