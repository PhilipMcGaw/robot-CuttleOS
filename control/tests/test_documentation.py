...
MONOREPO_ROOT = ROOT
REQUIRED = ("docs/CONTRIBUTING.md", "docs/README.md", "docs/documentation-policy.md", "docs/status.md", "docs/testing.md", "docs/hardware.md")
...
def main() -> int:
    ...
    files = [MONOREPO_ROOT / "MASTER_CONTEXT.md", MONOREPO_ROOT / "docs/CONTRIBUTING.md", *sorted((MONOREPO_ROOT / "docs").glob("*.md"))]
