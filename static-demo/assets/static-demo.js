...
function animate(now) {
    ...
    document.querySelector("[data-demo-time]").textContent = new Date().toLocaleTimeString([], { hour: "2-digit", minute: "2-digit", second: "2-digit", hour12: false });
    window.requestAnimationFrame(animate);
}
window.requestAnimationFrame(animate);
//# sourceMappingURL=static-demo.js.map